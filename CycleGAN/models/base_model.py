...
class BaseModel(ABC):
    """an abstract base class (ABC) for models."""
    ...
    def setup(self):
        ...
        if self.isTrain:
            self.schedulers = [networks.get_scheduler(optimizer, n_epochs=100, n_epochs_decay=100, lr_policy=self.lr_policy, lr_decay_iters=50, epoch_count=1) for optimizer in self.optimizers]
