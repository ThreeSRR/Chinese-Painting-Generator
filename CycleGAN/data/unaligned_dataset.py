...
class UnalignedDataset(BaseDataset):
    ...
    def __init__(self, dataroot, phase='train', load_size=286, crop_size=256, serial_batches=False, input_nc=3, output_nc=3, no_flip=True):
        ...
        btoA = False # default direction is AtoB
        self.transform_A = get_transform(load_size=self.crop_size, crop_size=self.crop_size)
        self.transform_B = get_transform(load_size=self.crop_size, crop_size=self.crop_size)
